...
## Implementation
This is partly rewritten/referenced from https://github.com/ToruNiina/lbvh to be more optimized, simple to use, and importantly bug free. It was written as a module of KittenEngine, a simulation framework I wrote for research. 
